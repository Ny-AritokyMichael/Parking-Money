...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @auth
                                    <li class="user-header">
                                        <img src="{{ asset('apple-touch-icon.png') }}" class="img-circle"
                                            alt="User Image">
                                        <p>{{ Auth::user()->name }}</p>
                                ...
                                <li class="user-footer">
                                    <div class="pull-center">
                                        {{-- <a class="btn btn-danger" style="width: 100%" href="{{ url('/') }}"><i class="fa fa-spinner fa-spin"></i> Log out</a> --}}
                                        <form action="{{ route('logout') }}" method="POST" class="d-none">
                                            @csrf
                                            <button class="btn btn-danger" style="width: 100%"><i
                                                    class="fa fa-spinner fa-spin"></i>Log out</button>
                                        </form>
                                    </div>
                                </li>
                            </ul>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left image">
                        <img src="{{ asset('apple-touch-icon.png') }}" class="img-circle" alt="User Image">
                    </div>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    {{-- <li >
            <a href="{{ route('userParking') }}">
              <i class="fa fa-cab"></i> <span>Parking Review</span>
            </a>
          </li> --}}
                    <li>
                        <a href="{{ route('client') }}">
            ...
            <i class="fa fa-user-secret"></i> <span>Account</span>
          </a>
        </li> --}}
