                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($voitures as $voiture)
                                        @if ($voiture->pourcentage < 0)
                                            <tr>
                                                <td>{{ $voiture->marque }}</td>
                                                <td>{{ $voiture->numeroImmatricule }}</td>
                                                <td>{{ $voiture->dateDebut }}</td>
                                                <td>{{ $voiture->temps }}</td>
                                                <td>Amender de 150.000ar</td>
                                                {{-- <td>Parking 67ha</td> --}}
                                                <td align="center">
                                                    <form
                                                    action="{{ route('pdf',['id'=>$voiture->id]) }}" method="post">
                                                    @csrf
                                        ...
                                        @elseif ($voiture->pourcentage < 25)
                                            <tr>
                                                ...
                                                <td align="center"><span
                                                        class="btn btn-danger btn-xs">{{ $voiture->pourcentage }}
                                                        %</span>
                                                </td>
                                                {{-- <td>Parking 67ha</td> --}}
                                                <td align="center">
                                        ...
                                        @elseif ($voiture->pourcentage > 25 && $voiture->pourcentage < 50)
                                            <tr>
                                                <td>{{ $voiture->marque }}</td>
                                                <td>{{ $voiture->numeroImmatricule }}</td>
                                                <td>{{ $voiture->dateDebut }}</td>
                                                <td>{{ $voiture->temps }}</td>
                                                <td align="center"><span
                                                        class="btn btn-warning btn-xs">{{ $voiture->pourcentage }}
                                                        %</span>
                                                </td>
                                                {{-- <td>Parking 67ha</td> --}}
                                                <td align="center">
                                        ...
                                        @elseif ($voiture->pourcentage > 50 && $voiture->pourcentage < 75)
                                            <tr>
                                                <td>{{ $voiture->marque }}</td>
                                                <td>{{ $voiture->numeroImmatricule }}</td>
                                                <td>{{ $voiture->dateDebut }}</td>
                                                <td>{{ $voiture->temps }}</td>
                                                <td align="center"><span
                                                        class="btn btn-info btn-xs">{{ $voiture->pourcentage }}
                                                        %</span>
                                                </td>
                                                {{-- <td>Parking 67ha</td> --}}
                                                <td align="center">
                                                    <form
                                                    action="{{ route('pdf',['id'=>$voiture->voiture_id]) }}" method="post">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm"
                                                    style="background-color:#be00e6; color:white"><i
                                                        class="fa fa-upload"></i></button>
                                        ...
                                        @elseif ($voiture->pourcentage > 75)
                                            <tr>
                                                ...
                                                <td>{{ $voiture->temps }}</td>
                                                <td align="center"><span
                                                        class="btn btn-success btn-xs">{{ $voiture->pourcentage }}
                                                        %</span>
                                                </td>
                                                {{-- <td>Parking 67ha</td> --}}
                                                <td align="center">
                        ...
                        @if (session()->has('error'))
                            <h1>{{ session('error') }}, Mr(s) {{ Auth::user()->name }} !</h1>
                        @endif
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
