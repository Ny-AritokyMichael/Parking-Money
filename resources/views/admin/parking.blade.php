                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <button type="button" class="btn btn-success btn-sm" style="margin-left: 2%"
                                data-toggle="modal" data-target="#parking">
                                Add
                            </button>
                            ...
                            <form action="#">
                                ...
                                <button type="button" class="btn btn-warning btn-sm"
                                    style="margin-left: 20%;margin-top: -93px" data-toggle="modal" data-target="#time">
                            ...
                            <div class="modal fade" id="parking">
                                <div class="modal-dialog">
                                    <div role="form">
                                        <form action="{{ route('add') }}" method="post" enctype="multipart/form">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Add parking</h4>
                                                </div>
                                                    ...
                                                    <div class="box box-primary">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Date now
                                                                :</label>
                                                            <input id="exampleInputEmail1" type="date"
                                                                class="form-control" name="date">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Combien de parking possedez-vous
                                                                ?
                                                            </label>
                        ...
                        @endif
                            ...
                            <div class="modal fade" id="time">
                                <div class="modal-dialog">
                                    <div role="form">
                                        <form action="{{ route('getnow') }}" method="post" enctype="multipart/form">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"
