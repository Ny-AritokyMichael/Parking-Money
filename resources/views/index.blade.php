...
<head>
    ...
    <title>Parking_Money@-Rjr.com</title>
        ...
        <div class="container">
            <div class="login-box">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="logo">
                            <span class="logo-font" style="color: rgb(255, 169, 9);">Parking </span>Money
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <form class="login-form" method="post" action="{{ route('logAdmin') }}">
                            ...
                            <div class="form-group">
                                <input required="true" type="Password" class="form-control" placeholder="Password"
                                    name="mdp">
                                <a href="#!" class="forgot-password" style="color: rgb(0, 168, 197);">Forgot Password?</a>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-warning btn-block" >LOGIN</button>
                            </div>
                            <div class="form-group">
                                <div class="text-center">New Member? <a href="#!" style="color: rgb(0, 168, 197);">Sign up Now</a></div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="slider-feature-card">
                                        ...
                                        <h3 class="slider-title"><a style="color: orange;" href="{{ route('loginAdmin') }}">Admin</a></h3>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="slider-feature-card">
                                        <img src="https://i.imgur.com/YMn8Xo1.png" alt="">
                                        <p class="slider-description">Connected about :</p>
                                        <h3 class="slider-title"><a style="color: orange;" href="{{ route('client') }}">Client</a></h3>
                                    </div>
                                </div>
                            </div>
